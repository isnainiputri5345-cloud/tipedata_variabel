...
echo " Welcome to my website for php a materi";
...
echo '<br><br><a href="materi4.php"><button>Ke materi 4: Database</button></a>';
...
echo '<br><br><a href="Tugas1.php"><button>Ke tugas 1:Mini projeck perulangan </button></a>';
echo '<br><br><a href="Tugas2.php"><button>ke tugas 2:Membuat form login </button></a>';
echo '<br><br><a href="Tugas3.php"><button>Ke tugas 3: </button></a>';
